...
object AppColors {
    ...
    val Green30 = Color(0xFF1D4B35) // primaryDark
    val Green40 = Color(0xFF2D6B4D) // Primary
    ...
    val Neutral6 = Color(0xFF0E1210) // background dark
